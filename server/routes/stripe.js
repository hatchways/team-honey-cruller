...
const { createCustomer, setUpIntents, retrieveCustomer, deleteCustomer, createCheckoutSession, chargeCard, attachPaymentMethod, listPaymentMethod, updatePaymentMethod } = require('../controllers/stripe');
...
router.route('/list-card').post(protect, listPaymentMethod);
router.route('/update-payment').post(protect, updatePaymentMethod);
