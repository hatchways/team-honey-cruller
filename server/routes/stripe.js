...
const { createCustomer, setUpIntents, retrieveCustomer, deleteCustomer, createPaymentMethod, createCheckoutSession, chargeCard, attachPaymentMethod, createToken } = require('../controllers/stripe');
