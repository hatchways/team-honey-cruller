...
export const getAllContests = async (date: string, createdAt?: string): Promise<AuthApiData> => {
  ...
  return await fetch(`/contest/?deadlineDate=${date}&createdAt=${createdAt}`, fetchData)
    .then((data) => data.json())
